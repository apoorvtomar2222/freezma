...
myapp.factory('UserService',['$http','$q', function($http, $q){
	return
	{
		...
		{
			return $http.post('http://localhost9000/freezma/updateLikes',item).then
			(
					function(response)
					{
 ...
 */
 ...
 myapp.factory('UserService', ['$http', '$q', function($http, $q){
	    ...
	    return {
			...
			{
									return $http
											.post('http://localhost:9000/freezma/fetchcomment/')
											.then(
													function(response) 
													{
														return response.data;
			...
			{
									return $http
											.post('http://localhost:9000/freezma/updateLike/',item)
											.then(
													function(response) 
													{
														return response.data;
		...
		{
								return $http
										.post('http://localhost:9000/freezma/submitComment/',item)
										.then(
												function(response) 
												{
													return response.data;
